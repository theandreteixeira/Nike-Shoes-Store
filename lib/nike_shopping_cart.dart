...
class _NikeShoppingCartState extends State<NikeShoppingCart>
  ...
  Widget _buildPanel() {
    ...
    final num currentImageSize = (_imageSize * _animationResize.value)
    ...
    return Material(
      ...
      child: AnimatedBuilder(
          ...
          builder: (context, child) {
            final num buttonSizeWidth =
                (_buttonSizeWidth * _animationResize.value).clamp(
              _buttonCircularSize,
              _buttonSizeWidth,
            );
            final num panelSizeWidth = (size.width * _animationResize.value)
                .clamp(_buttonCircularSize, size.width);
            return Stack(
              fit: StackFit.expand,
              children: <Widget>[
                    ...
                    children: <Widget>[
                      if (_animationMovementIn.value != 1)
                        Positioned(
                          ...
                          width: panelSizeWidth as double?,
                          child: _buildPanel(),
                        ),
                      Positioned(
                        bottom:
                            20 - (_animationMovementOut.value * 100) as double?,
                              ...
                              builder: (_, sizeSelected, __) {
                                return InkWell(
                                  onTap: (sizeSelected != null)
                                      ...
                                      : null,
                                  child: Container(
                                    width: buttonSizeWidth as double?,
